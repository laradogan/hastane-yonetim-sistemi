...
<div class="poliklinikler">
	...
	<br>
	<div class="cikis"><a href="logout.php">ÇIKIŞ YAP</div>
</div>
</div>
<div class="content">
<div class="header">
...
<div class="icerik">
	...
	<form action="doktor_ekle_vt.php" method="POST">
	


	<label><b>Doktor ID</b></label>
	<input class="form-control" type="text" name="doktor_id">
	
	
	<label><b>Doktor Adı</b></label>
	<input class="form-control" type="text" name="doktor_ad">
	
	
	<label><b>Doktor Soyadı</b></label>
	<input  class="form-control" type="text" name="doktor_soyad">
	
	
	<label><b>Doğum Tarihi</b></label>
	<input class="form-control" type="text" name="doktor_dogumtarihi">
	
	
	<label><b>Poliklinik ID</b></label>
	<input class="form-control" type="text" name="poliklinik_id">
