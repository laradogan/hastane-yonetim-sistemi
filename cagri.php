...
<html>
<head>
	<title>ÇAĞRI KAYDI BİLGİSİ</title>
	<meta charset="utf-8">
...
<div class="icerik">
    ...
    <tr>
        <th> Çağrı ID</th>
        <th> Çağrı Nedeni</th>
        <th> Çağrı Kaydı Tarihi</th>
        <th>Sil</th>
        <th>Düzenle</th>
        <th><a href="cagri_ekle.php" class="btn btn-success">Ekle</a></th>
    </tr>
...
$sorgu = $baglanti->query("SELECT * FROM cagri"); 

while ($sonuc = $sorgu->fetch_assoc()) { 

$cagri_id = $sonuc['cagri_id']; 
$cagri_nedeni = $sonuc['cagri_nedeni'];
$cagri_kayit_tarihi = $sonuc['cagri_kayit_tarihi'];

?>
    
    <tr>
        <td><?php echo $cagri_id; ?></td>
        <td><?php echo $cagri_nedeni; ?></td>
        <td><?php echo $cagri_kayit_tarihi; ?></td>
