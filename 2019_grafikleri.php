...
FROM cagri_kaydi
WHERE cagri_kaydi.tarih<'2020-01-01' AND cagri_kaydi.tarih>'2019-01-01'
...
WHERE hasta.doktor_id=doktor.doktor_id AND doktor.poliklinik_id=poliklinik.poliklinik_id AND hasta.hasta_id=hasta_tetkik.hasta_id AND tetkik.tetkik_id=hasta_tetkik.tetkik_id AND hasta_tetkik.tetkik_tarih<'2020-01-01' AND hasta_tetkik.tetkik_tarih>'2019-01-01'
...
<html>
<head>
  <title>2019 YILI Grafikleri</title>
...
function drawBasic() {
      ...
      var options = {
        title: '2019 Yılı polikliniklere giden Hasta Oranları',
        chartArea: {width: '50%'},
        colors:['orange'],
        hAxis: {
          minValue: 0
...
WHERE cagri_verilmeyen.tarih<'2020-01-01' AND cagri_verilmeyen.tarih>'2019-01-01'
...
$sorgu = $baglanti->query("SELECT poliklinik_cevap_verilmeyen.poliklinik_adi as ad,COUNT(poliklinik_cevap_verilmeyen.cevap_id) as hasta_sayisi
  FROM poliklinik_cevap_verilmeyen WHERE poliklinik_cevap_verilmeyen.tarih='2019-06-06' GROUP BY poliklinik_cevap_verilmeyen.poliklinik_id"); 
