...
<div class="icerik">
	...
	<form action="cagri_ekle_vt.php" method="POST">
	


	<label><b>Çağrı ID</b></label>
	<input class="form-control" type="text" name="cagri_id">
	
	
	<label><b>Çağrı Nedeni</b></label>
	<input class="form-control" type="text" name="cagri_nedeni">
	
	
	
	<label><b>Çağrı Kaydı Tarihi</b></label>
	<input class="form-control" type="text" name="cagri_kayit_tarihi">
