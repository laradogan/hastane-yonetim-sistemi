...
$cagri_kayit_tarihi=$_POST["cagri_kayit_tarihi"];
}


$sorgu=mysqli_query($baglanti,"INSERT INTO cagri (cagri_id,cagri_nedeni,cagri_kayit_tarihi) VALUES ('".$cagri_id."','".$cagri_nedeni."','".$cagri_kayit_tarihi."')");
if($sorgu==TRUE){
