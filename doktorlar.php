...
<br>
<div class="analiz"><a href="sonuc_analiz.php">SONUÇ ANALİZİ</a></div>
	<hr>
...
<div class="icerik">
<table class="table table-bordered  table-hover table-striped table-blue">
    ...
    <tr>
        ...
        <th>Sil</th>
        <th>Düzenle</th>
        <th><a href="doktor_ekle.php" class="btn btn-success">Ekle</a></th>
    </tr>
...
$sorgu = $baglanti->query("SELECT * FROM doktor,poliklinik,randevu WHERE doktor.doktor_id=randevu.doktor_id AND poliklinik.poliklinik_id=randevu.poliklinik_id ORDER BY doktor.doktor_id"); 

while ($sonuc = $sorgu->fetch_assoc()) { 
$doktor_id=	$sonuc['doktor_id'];
$doktor_ad = $sonuc['doktor_ad']; 
$doktor_soyad = $sonuc['doktor_soyad'];
$doktor_dogum_tarihi = $sonuc['doktor_dogum_tarihi'];
$poliklinik_id = $sonuc['poliklinik_id'];
$poliklinik_ad=	$sonuc['poliklinik_ad'];
...
?>
    ...
    <tr>
    	<td><?php echo $doktor_id; ?></td>
        <td><?php echo $doktor_ad; ?></td>
        <td><?php echo $doktor_soyad; ?></td>
        <td><?php echo $doktor_dogum_tarihi; ?></td>
        <td><?php echo $poliklinik_id; ?></td> 
        <td><?php echo $poliklinik_ad; ?></td>
